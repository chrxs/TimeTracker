...
class TimeRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_record" do
    assert_difference('TimeRecord.count') do
      post time_records_url, params: { time_record: { amount: @time_record.amount, date: @time_record.date, day_id: @time_record.day_id, project_id: @time_record.project_id } }, as: :json
    end
  ...
  test "should update time_record" do
    patch time_record_url(@time_record), params: { time_record: { amount: @time_record.amount, date: @time_record.date, day_id: @time_record.day_id, project_id: @time_record.project_id } }, as: :json
    assert_response 200
  end
